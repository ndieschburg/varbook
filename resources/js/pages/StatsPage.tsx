                    ...
                    <div className="space-y-3">
                        {stats.recent_sessions.map((session) => (
                            <Link
                                ...
                                className="flex items-center gap-4 p-3 bg-gray-100 dark:bg-slate-700/50 rounded-lg hover:bg-gray-200 dark:hover:bg-slate-700 transition-colors"
                            >
                                {session.book.cover_url ? (
                                    ...
                                    <div className="w-12 h-16 bg-gray-200 dark:bg-slate-600 rounded flex items-center justify-center">
                                        <BookIcon className="h-6 w-6 text-gray-400 dark:text-slate-500" />
                                    </div>
                                )}
