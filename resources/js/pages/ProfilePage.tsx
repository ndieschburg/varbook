...
export function ProfilePage() {
    ...
    return (
        <div className="max-w-2xl mx-auto space-y-8">
            ...
            {/* Update Profile Form */}
            <div className="bg-slate-800 rounded-xl border border-slate-700 p-6">
                <h2 className="text-lg font-semibold text-white mb-4">{t('Update Profile')}</h2>
            ...
            <div className="bg-slate-800 rounded-xl border border-slate-700 p-6">
                <h2 className="text-lg font-semibold text-white mb-4">{t('Change Password')}</h2>
                <form onSubmit={handleUpdatePassword} className="space-y-4">
                    <div>
                        ...
                        {errors.current_password && (
                            <p className="mt-1 text-sm text-red-400">{errors.current_password[0]}</p>
                        )}
                    </div>
