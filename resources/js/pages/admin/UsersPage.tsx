    ...
    return (
        <div>
            <div className="flex items-center justify-between mb-6">
                <h1 className="text-2xl font-bold text-gray-900 dark:text-white">{t('Users Management')}</h1>
            ...
            {users.length > 0 ? (
                ...
                <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 p-8 text-center">
                    <UserIcon className="mx-auto h-12 w-12 text-gray-400 dark:text-slate-600" />
                ...
                <div className="fixed inset-0 z-50 overflow-y-auto">
                    <div className="flex min-h-screen items-center justify-center p-4">
                        ...
                        <div className="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full p-6">
                            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">{t('Create User')}</h3>
                            <form onSubmit={handleCreate} className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="mt-1 block w-full rounded-md bg-gray-100 dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white"
                                        required
                                    />
                                    {errors.name && <p className="mt-1 text-sm text-red-500 dark:text-red-400">{errors.name[0]}</p>}
                                </div>
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                    />
                                    {errors.email && <p className="mt-1 text-sm text-red-500 dark:text-red-400">{errors.email[0]}</p>}
                                </div>
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                    />
                                    {errors.password && <p className="mt-1 text-sm text-red-500 dark:text-red-400">{errors.password[0]}</p>}
                                </div>
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">{t('Password')} (confirm)</label>
                                    <input
                                        type="password"
                                ...
                                <div className="flex items-center">
                                    <input
                                        ...
                                        className="rounded bg-gray-100 dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-indigo-600"
                                    />
                                    <label className="ml-2 text-sm text-gray-700 dark:text-gray-300">{t('Administrator')}</label>
                                </div>
